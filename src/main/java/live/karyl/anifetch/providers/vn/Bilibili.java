...
public class Bilibili extends AnimeProvider {
	...
	public AnimeParser search(AnilistInfo anilistInfo) {
		...
		if (providerId != null) {
			var episodes = extractEpisodeIds(connect(WATCH_URL + providerId, siteName));
	...
	public AnimeSource getLink(String value, boolean ignoreCache) {
		try {
			...
			animeSource.addHeader("Origin", "https://www.bilibili.tv/");
			animeSource.addHeader("Referer", "https://www.bilibili.tv/");
